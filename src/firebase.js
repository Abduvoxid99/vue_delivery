...
export default async function firebaseInitialize (shipper_id = '1ecca1e7-5c34-4055-b685-df59e5021cbf') {
...
messaging.onMessage(function (payload) {
    ...
    notification.onclick = function (event) {
      window.open(`https://test.app.delever.uz/orders/edit/${payload.data.order_id}?status_id=986a0d09-7b4d-4ca9-8567-aa1c6d770505`, '_blank')
      notification.close()
      console.log(event)
    }
})
